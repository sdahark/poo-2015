...
public class RetanguloANTIGO {
	...
	public RetanguloANTIGO(int x, int y, int altura, int largura) {
		this.x = x;
		this.y = y;
		this.altura = altura;
	...
	public static boolean igual(RetanguloANTIGO r1, RetanguloANTIGO r2) {	
